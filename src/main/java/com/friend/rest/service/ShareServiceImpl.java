...
import com.friend.rest.dao.ColumnsDao;
import com.friend.rest.dao.ColumnsStoryDao;
...
import com.friend.rest.service.model.LinkAccountWebModel;
...
//					
//					int follow_collection_count = 0;//userCollectionDao.getCollectionByCount(collection.getId());
...
//	 			User user = null;//collection.getUser();//userDao.get(collection.getAuthorId());
//	 			JSONObject author = new JSONObject();
...
//	 			ciJson.put("follow_count", 0);//collection.getUsers().size());
...
// 	         ci.setCover_image(JSONObject.fromObject(collection.getCover_image()));
//// 	         ci.setInfo(collection.getInfo());
//			User u = null;//collection.getUser();//.getId()userDao.get(collection.getAuthorId());
//			JSONObject author = new JSONObject();
//			author.put("id", u.getId());
//			author.put("username", u.getUsername());
//			if(!Strings.isNullOrEmpty(u.getAvatarImage())){
